...
class SignUpPolicyBiz extends StatefulWidget {
  const SignUpPolicyBiz({Key key}) : super(key: key);

  @override
  _SignUpPolicyBizState createState() => _SignUpPolicyBizState();
}

class _SignUpPolicyBizState extends State<SignUpPolicyBiz> {
